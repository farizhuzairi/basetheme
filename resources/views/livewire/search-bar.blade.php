...
<div class="absolute right-0 bg-primary outline outline-offset-2 outline-1 outline-primary px-3 py-2 rounded shadow-lg" x-show="sBar" x-cloak x-transition x-on:click.away="sBar = false">
    <x-base::form>
