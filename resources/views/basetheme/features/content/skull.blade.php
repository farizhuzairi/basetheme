...
<div {{
    ...
    <div class="grid grid-cols-2 gap-8">
        @for($x=0; $x < 4; $x++)
        <div class="border border-c-border rounded-lg bg-white hover:bg-c-theme text-c-text hover:text-c-text-white transition-all px-3 py-5 group">
            <div class="border-b-3 border-c-theme flex flex-row gap-5">
