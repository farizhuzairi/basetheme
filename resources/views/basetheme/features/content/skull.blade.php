...
<div {{
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
        @for($x=0; $x < 4; $x++)
        <div class="border border-c-border rounded shadow bg-white hover:bg-c-theme dark:hover:bg-c-theme text-c-text hover:text-c-text-white hover:scale-105 hover:-translate-y-3 transition-all group">
